...
initial_num=0
file_name='full_domain_concepts_'+str(initial_num)+'.txt'  #'full_concepts_for_openalex_'+str(initial_num)+'.txt'
...
new_file_name='full_domain_concepts_'+str(new_num)+'.txt' # the final concept file will be renamed as full_domain_concepts.txt
### 

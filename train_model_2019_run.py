...
if __name__ == '__main__':
    ...
    # it will create a main folder: 2016_train that contains subfolders: t0_c2_log, t0_c2_net, t0_c2_loss, t0_c2_curve, t0_c2_result 
    ...
    for yy in [year_start,year_start-1,year_start-2]:
        ...
        adj_mat=get_adjacency_matrix(full_dynamic_graph, yy, data_file) # load the adjacency_matrix file, if not exists, it will automatically generate one
        adj_mat_sparse.append(adj_mat) # adjacency_matrix for year y, y-1, y-2

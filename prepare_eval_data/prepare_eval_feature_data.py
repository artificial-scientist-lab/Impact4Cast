...
time_start = time.time()
#data_eval_pair_solutions=eval_data_pair_solution.values
#store_name=os.path.join(store_eval_folder,"eval_data_pair_solution.gz")
#with gzip.open(store_name, "wb") as f:
    #pickle.dump(data_eval_pair_solutions, f)
    
#with open(logs_file_name+".txt", "a") as myfile:
    #myfile.write(f"\neval_data_pair_solution: {len(data_eval_pair_solutions)}; elapsed_time: {time.time() - time_start}")
...
#time_start = time.time()
#store_name=os.path.join(store_eval_folder,"eval_data_pair_feature.gz")
#with gzip.open(store_name, "wb") as f:
    #pickle.dump(eval_data_features, f)
#print(f"store eval_data_features.gz: {len(eval_data_features)}; elapsed_time: {time.time() - time_start}")
#with open(logs_file_name+".txt", "a") as myfile:
    #myfile.write(f"\nstore eval_data_features.gz: {len(eval_data_features)}; elapsed_time: {time.time() - time_start}")
    #myfile.write(f"\n\n{datetime.now()}: {time.time() - time_start_begin}")
